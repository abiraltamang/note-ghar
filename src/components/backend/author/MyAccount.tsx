...
export default function MyAccount() {
  return (
    <div className="author-container">
      ...
      <div className="flex flex-col sm:flex-row items-center xxl:justify-center sm:items-start  sm:space-x-5  py-3">
        ...
        <div className=" w-full sm:w-[650px] xl:w-[804px] h-full p-4 dashboard-border font-Inter font-normal text-[#263238]  ">
