...
export default function Goal() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 items-center justify-around mx-[22px] sm:mx-[55px] md:md:mx-[65px] lg:mx-[80px] xl:mx-[125px] py-5 sm:py-10 lg:py-20">
      {goals.map((goal: any, index: any) => (
        ...
        >
          <div className="relative h-[70px] w-[70px] xl:h-[83px] xl:w-[83px]">
            <Image src="/insight.png" layout="fill" />
          </div>
