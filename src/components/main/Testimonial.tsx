        ...
        <div className='mb-14'>
            <div className='flex flex-col items-center justify-center'>
                <div className='text-[#37474F] text-center'>
                    <p className='text-5xl  font-bold font-Jost mb-4'>Trusted by Best Readers</p>
                    <span className='mx-24' >It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</span>
                </div>
